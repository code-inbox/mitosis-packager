...
const bundle: RollupOptions[] = [
    {
        ...
        plugins: [
            peerDepsExternal({
                packageJsonPath: path.resolve(process.cwd(), 'packages/react/package.json')
            }) as any,
            resolve(),
            commonjs(),
        ...
        plugins: [
            peerDepsExternal({
                packageJsonPath: path.resolve(process.cwd(), 'packages/svelte/package.json')
            }) as any,
            resolve(),
            commonjs(),
        ...
        plugins: [
            peerDepsExternal({
                packageJsonPath: path.resolve(process.cwd(), 'packages/solid/package.json')
            }) as any,
            resolve(),
            commonjs(),
    ...
    },
    {
        ...
        plugins: [
            peerDepsExternal({
                packageJsonPath: path.resolve(process.cwd(), 'packages/vue/package.json')
            }) as any,
